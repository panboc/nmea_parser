...
static void UnityTestResultsBegin(const char* file, const UNITY_LINE_TYPE line)
{
    ...
    UNITY_OUTPUT_CHAR(':');
#else
/* [USER EXT] 2021/09/08 - Remy SHI : add user test result output format */
#ifdef UNITY_USER_EXTENSION_OUPUT_RESULT
    UnityPrint("[");
    UnityPrint(file);
    UnityPrint("] [");
    UnityPrintNumber((UNITY_INT)line);
...
/*-----------------------------------------------*/
/* [USER EXT] 2021/09/08 - Remy SHI : edit fail results */
#ifdef UNITY_USER_EXTENSION_OUPUT_RESULT
...
/* [USER EXT] 2021/09/08 - Remy SHI : print pass results */
#ifdef UNITY_USER_EXTENSION_PRINT_PASS
static void UnityTestResultsPassBegin(const UNITY_LINE_TYPE line)
{
    UnityPrint("[");
                     ...
                     const UNITY_LINE_TYPE lineNumber)
{
    ...
    if ((mask & expected) != (mask & actual))
    {
        ...
        UnityAddMsgIfSpecified(msg);
        /* [USER EXT] 2021/09/30 - Remy SHI : add \n for test fail */
#ifdef UNITY_USER_EXTENSION_PRINT_FAIL
        UNITY_PRINT_EOL();
#endif
        UNITY_FAIL_AND_BAIL;
    }
    /* [USER EXT] 2021/09/08 - Remy SHI : printf pass results */
#ifdef UNITY_USER_EXTENSION_PRINT_PASS
